...
public class BoardGame
{
    ...
    public ICollection<BoardGames_Domains>? BoardGamesDomainsCollection { get; set; }
    public ICollection<BoardGames_Mechanics>? BoardGamesMechanicsCollection { get; set; }
